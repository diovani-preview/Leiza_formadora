    ...
    <article class="journey-card" data-card-index="${index}">
      ...
      <div class="image-wrap">
        <button class="image-button" type="button" aria-label="Avançar o quadro ${index + 1} para a Cena 2">
          ...
          <span class="image-overlay"><span class="click-hint">Clique para avançar</span></span>
        </button>
...
function updateCard(cardIndex) {
  ...
  card.querySelector(".click-hint").textContent = sceneIndex === 2 ? "Sequência concluída" : "Clique para avançar";
